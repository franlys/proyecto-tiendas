...
export default function PaymentSettingsPage() {
  ...
  const [config, setConfig] = useState<ShopManualPaymentConfig>(
    DEFAULT_MANUAL_PAYMENT_CONFIG,
  );
              ...
              <div className="flex items-center gap-4 w-full sm:w-auto">
                {config.requireUpfrontPayment && (
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      min="10"
                      max="90"
                      value={config.upfrontPaymentPercentage || 50}
                      onChange={(e) => {
                        const val = parseInt(e.target.value);
                        setConfig((prev) => ({
                          ...prev,
                          upfrontPaymentPercentage: isNaN(val) ? 50 : val,
                        }));
                        setIsSaved(false);
                      }}
                ...
                <div
                  ...
                  onClick={() => {
                    setConfig((prev) => ({
                      ...prev,
                      requireUpfrontPayment: !prev.requireUpfrontPayment,
                    }));
                    setIsSaved(false);
                  }}
                >
              ...
              {config.paymentMethods.length === 0 ? (
                <div className="text-center py-12 text-slate-400">
                  ...
                  <p className="text-sm mt-1">
                    Agrega uno para que tus clientes puedan pagarte
                  </p>
                </div>
              ) : (
