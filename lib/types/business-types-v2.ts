...
export const BUSINESS_TYPES: BusinessTypeConfig[] = [
    ...
    // ========== FOOD - MEAL PREP ==========
    { id: "meal_prep", label: "Meal Prep", icon: "🥗", category: "food", subcategory: "meal_prep_catering", keywords: ["meal prep", "comida fitness", "preparacion"], features: { ...F.food, services: true }, labels: { cta: "Ver Paquetes", products: "Paquetes", services: "Planes" } },
